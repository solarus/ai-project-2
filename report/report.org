...
* Results and Evaluation
  \label{sec:results}
   ...
   This chapter will present problems from the laboratory descripion and
...
it needs 42 steps to be solved. On the other hand, its planning time is still managable.
...
** Problems without working solution
   ...
   - /pick up the yellow pyramid above all red blocks:/\\
     ...
     is above all red blocks. To achive this, all red blocks must be
